...
func TestWithDefaultParameters(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"https://api.openweathermap.org/data/3.0/onecall?lat=3.14&lon=5.67&appid=c8b58ab0-1360-4a3a-9f70-3742e48ad2fe",
...
func TestWithOptionalParameters(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"https://api.openweathermap.org/data/3.0/onecall?lat=3.14&lon=5.67&appid=c8b58ab0-1360-4a3a-9f70-3742e48ad2fe&exclude=foo%2Cbar&units=metric&lang=en",
		httpmock.NewStringResponder(200, readTextFile(t, "testdata/sample.json")),
	)
